...
if (isset($_GET['delete_id'])) {
    ...
    $conn->query("DELETE FROM transactions WHERE id=$id AND type='income'");
    $msg = "<div class='alert success'>Record Deleted.</div>";
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action'])) {
    ...
    if ($_POST['action'] == 'add') {
        ...
        if ($stmt->execute()) $msg = "<div class='alert success'>Income Recorded!</div>";
    ...
    elseif ($_POST['action'] == 'edit') {
        ...
        if ($stmt->execute()) $msg = "<div class='alert success'>Record Updated!</div>";
    }
}

// FETCH
$incomes = $conn->query("SELECT * FROM transactions WHERE type='income' ORDER BY trans_date DESC LIMIT 50");
?>
...
<head>
    <meta charset="UTF-8">
    <title>Other Revenue | Delight Dairy</title>
    <link rel="stylesheet" href="../../assets/css/dashboard.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        .top-bar { display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; }
        .btn-add { background: #27ae60; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; border: none; cursor: pointer; font-weight: bold; }
...
<body>
    ...
    <div class="main-content">
        <div class="top-bar">
            <div>
                <h2>Other Revenue (Non-Sales)</h2>
                <p style="color:#777; margin:0;">Record miscellaneous income sources.</p>
            </div>
            <button onclick="openModal('add')" class="btn-add"><i class="fas fa-plus-circle"></i> Add Revenue</button>
        </div>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span style="background:#e8f8f5; color:#27ae60; padding:3px 8px; border-radius:4px; font-size:12px;"><?php echo $row['category']; ?></span></td>
    ...
    <div id="incModal" class="modal">
        <div class="modal-content">
            <h3 id="modalTitle" style="margin-top:0;">Record Other Income</h3>
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="category" id="category">
                        ...
                        <option value="Asset Sale">Asset Sale / Disposal</option>
                ...
                <button type="submit" class="btn-add" id="btnSave" style="width:100%;">Save Revenue</button>
                <button type="button" onclick="document.getElementById('incModal').style.display='none'" style="width:100%; margin-top:5px; background:#ccc; border:none; padding:10px; border-radius:5px; cursor:pointer;">Cancel</button>
            </form>
        </div>
    </div>
    ...
    <script>
        function openModal(mode, data=null) {
            ...
            if(mode == 'edit') {
                document.getElementById('modalTitle').innerText = 'Edit Revenue';
                ...
                document.getElementById('btnSave').innerText = 'Save Revenue';
